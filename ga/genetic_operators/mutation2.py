...
class Mutation2(Mutation):
    ...
    def mutate(self, ind: IntVectorIndividual) -> None: #troca um produto por outro
        num_genes = len(ind.genome)
        pos1 = GeneticAlgorithm.rand.randint(0, num_genes - 1)
        pos2 = pos1
        while (pos1 == pos2): #para assegurar que há troca (para casotenha calhado os mesmos numeros)
